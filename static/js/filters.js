...
GmailCleaner.Filters = {
    ...
    get() {
        ...
        return {
            ...
            sender: sender,
            label: label,
            has_attachment: document.getElementById('filterAttachment')?.value || '',
            inbox_only: document.getElementById('filterInboxOnly')?.value || ''
        };
    },
    ...
    clear() {
        ...
        const filterAttachment = document.getElementById('filterAttachment');
        const filterInboxOnly = document.getElementById('filterInboxOnly');
        if (filterAttachment) filterAttachment.value = '';
        if (filterInboxOnly) filterInboxOnly.value = '';
